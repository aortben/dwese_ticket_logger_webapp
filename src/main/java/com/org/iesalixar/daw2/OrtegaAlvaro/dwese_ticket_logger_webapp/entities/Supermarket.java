...
public class Supermarket {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY) // Generación automáticadel ID.
    private Integer id;
     ...
     */
    // Relación uno a muchos con la entidad `Location`. Un supermercado puede tenermuchas ubicaciones.
